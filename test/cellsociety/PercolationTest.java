...
public class PercolationTest extends CellSocietyTest {
    public static final String GOL_CONFIG_TESTS_PATH = "test_configs/Percolation/";
...
//        SimModel simModel = createModelFromFile(PercolationSimModel.class,
//                GOL_CONFIG_TESTS_PATH + "beehive" + CONFIG_TESTS_EXTENSION);
//        testPercolationStillLifes(simModel);
//    }
...
//
//    @Test
//    private void testPercolationStillLifes(SimModel simModel) {
//        Grid<PercolationCell> grid = simModel.getGrid();
